...
function getNumericColumn(result, item) {
  return (
    result?.numeric_column ||
    item?.numeric_column ||
    (
...
function getGroupColumn(result, item) {
  return (
    result?.group_column ||
    item?.group_column ||
    (
...
function normaliseResults(analysis, plan, project) {
  const output = [];
